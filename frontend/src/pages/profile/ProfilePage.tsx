	...
	return (
		<>
				...
				<div className='flex flex-col'>
					{!isLoading && user && (
						<>
              <PageHeading title={user?.fullName}>
                <span className='text-sm text-neutral'>{POSTS?.length} posts</span>
              </PageHeading>
							...
							<div className='relative group/cover'>
								...
								<div className='avatar absolute -bottom-16 left-4'>
									<div className='w-32 rounded-full relative group/avatar'>
										<img src={profileImg || user?.profileImg || "/avatar-placeholder.png"} alt="Profile Avatara"/>
                    ...
                    type="button"
							...
							<div className='flex flex-col gap-4 mt-8 px-4'>
								<div className='flex flex-col'>
									...
									<span className='text-base text-neutral'>@{user?.username}</span>
								...
								<div className='flex gap-2 flex-wrap'>
									...
									<div className='flex gap-2 items-center'>
										...
										<span className='text-sm text-neutral'>Joined {formatDate(user?.createdAt)}</span>
									</div>
								</div>
              ...
              <Tabs tabs={tabs} activeTab={feedType} setActiveTab={setFeedType} className="mt-4"/>
						</>
					)}
